...
[dtctl docs](../README.md) / [Resources](README.md) / Workflows
...
# Pass input as a JSON object and wait for completion, then show task results
dtctl exec workflow workflow-123 --input '{"env":"prod"}' --wait --show-results
