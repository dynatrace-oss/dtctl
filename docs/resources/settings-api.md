...
[dtctl docs](../README.md) / [Resources](README.md) / Settings
...
# Get a specific schema by its ID (positional)
dtctl get settings-schemas builtin:openpipeline.logs.pipelines
