...
- [x] Output formatters: JSON, YAML, table, wide, CSV, describe, chart, sparkline, barchart
...
- [x] `skills` - AI agent skill file management (install, uninstall, status for Claude, Copilot, Cursor, Kiro, OpenCode, OpenClaw)
