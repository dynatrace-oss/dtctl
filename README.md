...
- **Built for AI agents** — Predictable verb-noun commands, structured output (`--plain`, `-o json`, `-o describe`, `--agent`), machine-readable command catalog (`dtctl commands`), and YAML-based editing make dtctl a natural tool for LLM-driven automation
