...
func (h *Handler) Get(id string) (*AzureMonitoringConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get azure monitoring config %q: %w", id, err)
	}
	if err := httpclient.CheckResponse(resp); err != nil {
		return nil, fmt.Errorf("get azure monitoring config %q: %w", id, err)
	}
...
func (h *Handler) List() ([]AzureMonitoringConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("list azure monitoring configs: %w", err)
	}
	if err := httpclient.CheckResponse(resp); err != nil {
		return nil, fmt.Errorf("list azure monitoring configs: %w", err)
	}
...
func (h *Handler) Create(data []byte) (*AzureMonitoringConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("create azure monitoring config: %w", err)
	}
	if err := httpclient.CheckResponse(resp); err != nil {
		return nil, fmt.Errorf("create azure monitoring config: %w", err)
	}
...
func (h *Handler) Update(id string, data []byte) (*AzureMonitoringConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("update azure monitoring config %q: %w", id, err)
	}
	if err := httpclient.CheckResponse(resp); err != nil {
		return nil, fmt.Errorf("update azure monitoring config %q: %w", id, err)
	}
...
func (h *Handler) Delete(id string) error {
	...
	if err != nil {
		return fmt.Errorf("delete azure monitoring config %q: %w", id, err)
	}
	if err := httpclient.CheckResponse(resp); err != nil {
		return fmt.Errorf("delete azure monitoring config %q: %w", id, err)
	}
